...
ffmpeg_mp4 = "ffmpeg -i {} -ss 0 -t {} -f lavfi -i color=c=0x000000:s=770x432:r=25 -i {} -filter_complex \"[2:v]scale=770:432[v2];[1:v][v2]overlay=x=0:y=0[outv];[0:0]\" -map [outv] -map [0:a] -vcodec libx264 -acodec copy -y -f mp4 {}"
print('pipetest v2.1:',ffmpeg_mp4)
