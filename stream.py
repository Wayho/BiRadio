...
print('stream v5.10.3:ffmpeg_rtmp_mp4',ffmpeg_rtmp_mp4)
...
def amix_next_mp4(mp4,amix,adelay=10000,framerate=25):
    ...
    a_contac = joined[0]
    adelay = adelay + random.randint(0,10)*1000
    ...
    try:
        ...
        ret = False
    print('amix_next_mp4:adelay={} seconds={}'.format(adelay,time.time()-t_start))
    return ret
